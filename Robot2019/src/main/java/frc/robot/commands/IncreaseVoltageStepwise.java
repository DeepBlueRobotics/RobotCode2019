...
*/
public class IncreaseVoltageStepwise extends DrivetrainCharacterization {
    private Drivetrain dt;
    private FileWriter fw;
    public double suppliedVoltage, voltStep, stepwiseVoltage, voltageRuntime, maxVoltage;

    public IncreaseVoltageStepwise(Drivetrain dt, double voltStep, double stepwiseVoltage, String filename) {
